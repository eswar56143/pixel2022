<div style="-webkit-transform:translate3d(140%, 0,
    ...
    <div class="section scroll">
        ...
        <div class="wrapper" style="display: flex; flex-direction: column; margin-bottom: 300px">
            ...
            <form  method="post" id="register-form" onsubmit="">
                @csrf
                <div class="input-box">
                ...
                <div class="input-box">
                    <input type="tel" id="mob" onblur="mobile_validate()" name="contact" placeholder="Phone Number" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}$" required class="form_data">
                </div>
                <div class="error">
                    <span id="mob-error" style="color: #cc0033;
                        font-family: Helvetica, Arial, sans-serif; font-size: 13px;font-weight: bold; line-height: 20px;">
                    </span>
                </div>
                <div class="input-box">
