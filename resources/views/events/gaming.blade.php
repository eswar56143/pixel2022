        ...
        <div class="w-layout-grid grid-6 margin-bottom ">
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c2-ce4392dc" class="content">
                ...
                <div class="sticky-content">
                        ...
                        <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc10-cd4392e2 " class="section padding-2rem ">
                            ...
                            <div class="content horizontal middle ">
                                ...
                                <div class="margin-left ">
                                    ...
                                    <div>Solo</div>
                                    <h5 class="display-3 font-yellow ">150/-</h5>
                                    <div>Dual</div>
                    ...
                    <div class="register" style="max-width: 300px; min-width: 50px ;display: inline; padding: 1rem;">
                        <a data-w-id="8320fab2-82fb-d44f-d6ea-a5b42319c9c3" href="#" target="_blank" class="btn  w-inline-block" style="pointer-events: none;">
            ...
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content" style="padding: 2rem;">
                ...
                <div class="margin-paragraph w-richtext">
                    ...
                    <img src="../images/events/pubgludo.jpg" style="width: 100%;margin-top: 1rem;max-height: 280px; margin-bottom: 1rem;" alt="">
                    <p>This event is loaded with fun, participants will compete in the Multi Player game Battle Grounds Mobile India. A custom room will be created where participants are expected to compete in teams, the last team standing will win.</p>
                    <p>This is an online event and you can participate from anywheret. </p>
                    <p>
                        ...
                        <div class="w-layout-grid grid-contact border" style="background-color:#3B3566 ;">
                            ...
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533734-cd4392e2" class="section padding-2rem">
                                ...
                                <div class="content centered">
                                    ...
                                    <div class="show-item-onload">
                                        <div class="uppercase">
                                            <p style="color: white;">Phone:</p><a href="tel:7799490588" class="link-block w-inline-block">7799490588</a>
                                        </div>
                                    </div>
