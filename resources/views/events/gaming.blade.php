            ...
            <div class="w-layout-grid main-grid">
                <div id="w-node-_6ca352aa-f456-95fb-2b6c-2f7d864c63d1-ce4392dc" class="content centered">
                    <div class="show-item-onload margin-paragraph"
                        ...
                        <img src="../images/event-icons/gaming.png" style="min-height: 10px; max-height: 120px;">
            ...
            <div class="w-layout-grid grid-6 margin-bottom ">
                <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c2-ce4392dc" class="content">
                            ...
                            <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc10-cd4392e2 "
                                ...
                                <div class="content horizontal middle ">
                                    ...
                                    <div class="margin-left ">
                                        ...
                                        <div>Solo</div>
                                        <h5 class="display-3 font-yellow ">75/-</h5>
                                        <div>Duo</div>
                    ...
                    <div class="register" style="max-width: 300px; min-width: 50px ;display: inline; padding: 1rem;">
                        <a href="https://forms.gle/FWxiHF7Eiq3e4rcw9" target="_blank"
                        ...
                        <h5 class="display-3 font-yellow centered">FREE-FIRE Game</h5>
                        <div class="w-layout-grid grid-details-conference-info border ">
                    ...
                    <div class="register centered" style="max-width: 300px; min-width: 50px ;display: inline; padding: 1rem;">
                        <p class="centered">Registrations for Free-Fire are closed.</p>
                    </div>
                ...
                <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content"
                    ...
                    <div class="margin-paragraph w-richtext">
                        ...
                        <img src="../images/events/pubg.jpeg" style="width: 100%;margin-top: 1rem;max-height: 280px; margin-bottom: 1rem;" alt="">
                            ...
                            <p> </p>
                        <p>
                        <h5>Registration Rules For BGMI / FREE-FIRE Game</h5>
                        <ul>
                            <li>
                        ...
                        <h5>Event Rules For BGMI / FREE-FIRE Game</h5>
                        <p>
                        <ul>
                            <li>
                        ...
                        <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533727-cd4392e2">
                            <div class=" grid-contact border" style="padding: 1rem;">
                                <ul>
                                    ...
                                    <li>
                                        <h6> For every kill amount will be awarded.</h6>
                                    </li>
                                </ul>
                            </div>
