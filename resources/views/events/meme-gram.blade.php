        ...
        <div class="w-layout-grid main-grid">
            <div id="w-node-_6ca352aa-f456-95fb-2b6c-2f7d864c63d1-ce4392dc" class="content centered">
                <div class="show-item-onload margin-paragraph" style="display: flex;flex-direction: row;align-items: center;">
                    <img src="../images/event-icons/meme 1.svg" style="min-height: 10px; max-height: 120px;">
                        ...
                        <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc03-cd4392e2 " class="section padding-2rem ">
                            <div class="content horizontal middle ">
                                ...
                                <div class="margin-left ">
                                    <h5 class="display-3 font-yellow ">April, 2022</h5>
                                    <div>Dates</div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content" style="padding: 2rem;">
                ...
                <div class="margin-paragraph w-richtext">
                    ...
                    <ul>
                        ...
                        <li>
                            Payment of rupees 500 should be paid by each individual.
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            The meme should be appropriate to the topic provided.
                        </li>
                        <li>
                            One person is allowed only one meme.
                        </li>
                        <li>
                            Usage of any illegal means to garner more likes will lead to disqualifacation.
                        </li>
                    </ul>
                    </p>
                            ...
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d53372a-cd4392e2" class="section padding-2rem">
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">Y Sujana
                                        </div>
                                    </div>
                                    <div class="show-item-onload">
                                        <div class="uppercase">
                                            <p style="color:white;">Mail Id:</p> <a href="mailto:yallamgarisujana@gmail.com" class="link-block w-inline-block">yallamgarisujana@gmail.com</a>
                                        </div>
                            ...
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533734-cd4392e2" class="section padding-2rem">
                                ...
                                <div class="content centered">
                                    ...
                                    <div class="show-item-onload">
                                        ...
                                        <div class="uppercase">
                                            <p style="color:white;">Mail Id:</p> <a href="mailto:sudha.boya22@gmail.com" class="link-block w-inline-block">sudha.boya22@gmail.com</a>
                                        </div>
