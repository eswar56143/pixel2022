...
<head>
    ...
    <title>Memegram-Pixel 2022</title>
    <meta content="Memegram" name="description" />
        ...
        <div class="w-layout-grid main-grid">
            <div id="w-node-_6ca352aa-f456-95fb-2b6c-2f7d864c63d1-ce4392dc" class="content centered">
                <div class="show-item-onload margin-paragraph" style="display: flex;flex-direction: row;align-items: center;">
                    <img src="../images/event-icons/meme.png" style="min-height: 10px; max-height: 120px;">
                    <h1 class="display-1 small">Memegram</h1>
                </div>
            </div>
        ...
        <div class="w-layout-grid grid-6 margin-bottom ">
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c2-ce4392dc" class="content">
                ...
                <div class="sticky-content">
                    <div class="w-layout-grid grid-details-conference-info border ">
                        <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc03-cd4392e2 " class="section padding-2rem ">
                            <div class="content horizontal middle ">
                                ...
                                <div class="margin-left ">
                                    <h5 class="display-3 font-yellow ">April 27, 2022</h5>
                                    <div>Deadline</div>
                                </div>
                            </div>
                        </div>
                        <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc10-cd4392e2 " class="section padding-2rem ">
                            ...
                            <div class="content horizontal middle ">
                                ...
                                <div class="margin-left ">
                                    <h5 class="display-3 font-yellow ">FREE</h5>
                    ...
                    <div class="register centered" style="max-width: 300px; min-width: 50px ;display: inline; padding: 1rem;">
                        <p class="centered">Registrations for Memgram are closed.</p>
                    </div>
                </div>
            ...
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content" style="padding: 2rem;">
                ...
                <div class="margin-paragraph w-richtext">
                    ...
                    <img src="../images/events/meme.jpg" style="width: 100%;margin-top: 1rem;max-height: 280px; margin-bottom: 1rem;" alt="">

                    <p>Show us your sense of humour or sarcasm and win exciting prizes. In this event you will be provided a topic on which you are expected to make a meme and submit it, it will posted on on our social media pages, and the meme that
                        gets the most likes is considered as the winner.</p>
                    <p>This event does not require your presence as you can submit your memes from anywhere.</p>
                    ...
                    <p><p>
                        ...
                        <ul>
                            ...
                            <li>
                                You need to be registered in order to participate in this event.
                            </li>
                            <li>
                                You need to be send your memes on or before April 27 to <a href="https://www.instagram.com/memegram.pixel/" target="_blank" style="color:yellow">@memegram.pixel</a>.
                            </li>
                        ...
                        <ul>
                            <li>
                                Memes should be related to college.
                            </li>
                            <li>
                                Anyone can participate.
                            </li>
                            <li>
                                After registration, Dm name, instagram ID , mail , to <a href="https://www.instagram.com/memegram.pixel/" target="_blank" style="color:yellow">@memegram.pixel</a> for participation.
                            </li>
                            <li>
                                Follow Instagram <a href="https://www.instagram.com/memegram.pixel/" target="_blank" style="color:yellow">@memegram.pixel</a> for more updates
                            </li>
                    ...
                    <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533727-cd4392e2">
                        <div class=" grid-contact border" style="padding: 1rem;">
                            <ul>
                                ...
                                <li>
                                    <h6>Winners are anounced based on number of likes.</h6>
                                </li>
                        ...
                        <div class="w-layout-grid grid-contact border" style="background-color:#3B3566 ;">
                            ...
                            <div class="content centered">
                                    ...
                                    <div class="show-item-onload">
                                        <div class="uppercase">
                                            <p style="color: white;">Phone:</p><a href="tel:9490881902" class="link-block w-inline-block">9490881902</a>
                                        </div>
                                        <div class="uppercase">
                                            <p style="color:white;">Mail Id:</p> <a href="mailto:shaiksalmanssn@gmail.com" class="link-block w-inline-block">shaiksalmanssn@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533734-cd4392e2" class="section padding-2rem">
                                ...
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">B SUDHA RANi</div>
                                    </div>
